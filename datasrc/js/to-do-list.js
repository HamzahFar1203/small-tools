...
function post_to_task_viewer () {
    ...
    for (let item of list_of_tasks) {
        ...
        const new_list_item_tags = document.createElement("section");
        new_list_item_tags.className = "list_item_tags_container";
        ...
        // Creates the <p> which holds the time the task was created
        const new_list_item_time = document.createElement("p");
        new_list_item_time.className = "list_item_time";
        new_list_item_time.textContent = item.timeAdded;

        // Appends the date and time elements into the tags container section
        new_list_item_tags.append(new_list_item_date);
        new_list_item_tags.append(new_list_item_time);
        ...
        new_list_item.appendChild(new_list_item_tags);
